...
DATA_DIR = "../DataSets/ncf/ratings.dat"
DATA_PATH = "../DataSets/ncf/"
...
def load_data():
    ...
    return (
    (train_features, train_labels), (test_features, test_labels), (user_size, item_size), (user_bought, user_negative))
...
#     data_path = os.path.join(DATA_PATH, 'train.npy')
#     if not os.path.exists(data_path):
#         dump_data(features, labels, user_negative, num_neg, True)
#
#     data = np.load(data_path).items()
#
